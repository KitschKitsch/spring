...
public class HobbyController {
	...
	// 게시글 전체 가져오기
	@RequestMapping("/madangs_folder/madang_2_1")
	public String madang_2_1(PageDto pageDto, String s_opt, String s_word, @RequestParam(defaultValue = "10") String rowPP, Model model) {
		HashMap<String, Object> map = hobbyService.selectAll(pageDto, s_opt, s_word, rowPP);
