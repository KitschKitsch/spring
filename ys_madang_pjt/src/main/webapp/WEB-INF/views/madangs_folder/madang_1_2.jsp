	...
	<div class="block table-responsive grid-view">
		<table class="table table-bordered">
			...
			<thead>
				...
				<th colspan="4">
					<div class="col-md-12">
							<span class="ico-new"><img src="/resources/common/images/ico_new.gif" alt="New"></span>
...
function htmldecode(s){
	...
	<div id="mypage">
		...
		<div class="replyWrite">
			<ul>
				<li class="in">
					<p class="txt">총 <span class="orange">${list.size()}</span> 개의 댓글이 달려있습니다.</p>
					<label><p class="password">비밀글 여부 &nbsp; <input role="switch" type="checkbox" class="replynum"></p></label>
