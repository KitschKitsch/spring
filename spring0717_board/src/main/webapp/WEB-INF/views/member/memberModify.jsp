...
<c:if test="${sessionId==null }">
	<script>
		alert("로그인 하셔야 수정이 가능");
		loaction.href="/member/login";
	</script>
</c:if>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<section>
		<form name="agree" method="get" action="join03_success.html">
			...
			<fieldset class="fieldset_class">
				...
				<dl id="join_id_dl">
					...
					<dd>${mdto.id}
						...
						<input type="button" value="중복확인" /> <span>4~16자리의
							영문, 숫자, 특수기호(_)만 사용하실 수 있습니다.</span> <span>첫 글자는 영문으로 입력해 주세요.</span>
					</dd>
				</dl>
				<dl id="join_pw1_dl">
					<dt>
				...
				<dl id="join_interests_dl">
					...
					<dd>
						<ul>
							...
							<label for="computer">컴퓨터/인터넷</label></li>
							...
							<input type="checkbox" name="movie" id="movie" value="movie"/> 
								...
								<label for="movie">영화/비디오</label></li>
							...
							<label for="culture">문화/예술</label></li>
							...
							<label for="interier">인테리어</label></li>
							...
							<label for="leisure">레저/여가</label></li>
							...
							<label for="health">건강/다이어트</label></li>
							...
							<label for="fashion">패션/미용</label></li>
						</ul>
					</dd>
				</dl>
				...
				<dl id="join_mail_dl">
					...
					<dd>
						...
						<input type="text" id="main_tail" name="mail_tail" required /> <select>
				...
				<dl id="join_address_dl">
					...
					<dd>
						<input type="text" id="f_postal" name="f_postal" required /> <span>-</span>
						<input type="text" id="l_postal" name="l_postal" required /> <input
							type="button" value="우편번호" /> <input type="text" id="address1"
							name="address1" required /> <input type="text" id="address2"
				...
				<dl id="join_birth_dl">
					...
					<dd>
						...
						</select> <span>년</span> <select id="birth_month" name="birth_month"
							required>
							<option selected>선택</option>
						...
						</select> <span>월</span> <select id="birth_day" name="birth_day" required>
							<option selected>선택</option>
							<option value="1">1</option>
							<option value="2">2</option>
							<option value="3">3</option>
						...
						<div>
							<input type="radio" name="calendar" id="lunar" value="lunar"
								checked="checked" /> <label for="lunar">양력</label> <input
								type="radio" name="calendar" id="solar" value="solar" /> <label
								for="solar">음력</label>
						</div>
					</dd>
				</dl>
					...
					<dd>
						...
						<div>
							<input type="radio" name="newletter" id="newletter_y" value="yes"
								checked="checked" /> <label for="newletter_y">예</label> <input
								type="radio" name="newletter" id="newletter_n" value="no" /> <label
								for="newletter_n">아니오</label>
						</div>
					</dd>
				</dl>
				<dl id="join_sms_dl">
					...
					<dd>
						...
						<div>
							<input type="radio" name="sms" id="sms_y" value="yes"
								checked="checked" /> <label for="sms_y">예</label> <input
								type="radio" name="sms" id="sms_n" value="no" /> <label
								for="sms_n">아니오</label>
						</div>
					</dd>
				</dl>
			...
			<h4>
				분양 회원 정보 입력 <span>(다구좌 회원일 경우 가지고 계신 카드번호 중 하나를 입력해 주시면 됩니다)</span>
			</h4>
			<fieldset class="fieldset_class">
				<dl id="join_member_number_dl">
					...
					<dd>
						<input type="text" name="m_number" id="m_number" /> <span>하이픈(-)이나
							띄어쓰기 없이 입력해 주시기 바랍니다.</span>
					</dd>
				</dl>
				<dl id="join_verification_number_dl">
					...
					<dd>
						<input type="text" name="v_number" id="v_number" /> <span>숫자
							4자리 입력</span>
					</dd>
				</dl>
			</fieldset>
			...
			<fieldset class="fieldset_class">
				...
				<dl id="join_marital_status_dl">
					...
					<dd>
						<input type="radio" name="marital_status" id="marital_status_y"
							value="yes" /> <label for="marital_status_y">예</label> <input
							type="radio" name="marital_status" id="marital_status_n"
							value="no" /> <label for="marital_status_n">아니오</label>
					</dd>
				</dl>
