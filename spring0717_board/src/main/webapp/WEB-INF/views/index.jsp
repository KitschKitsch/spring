	...
	<section>
		...
		<div id="recomend">
			<div>
				<div>
					...
					<span>
						<a href="#">로그인</a>
						하시면 고객님의 구매내역과<br> 맛취향에 따라 딱맞는 맛있는 메뉴를 추천드려요
					</span>
				</div>
				<div></div>
		...
		<div id="review">
			<script>
				function boardBtn() {
					alert("글을 변경합니다.");
					// ajax: 화면변경하지않으면서 컨트롤러에서 데이터 가져오는 비동기식 방법 
					$.ajax({
						...
						success : function(data) {
							...
							var arrSrc = data[0].bfile.split(","); // 자바스크립트에서 split
							var src = "/upload/" + arrSrc[0]
							
							$(".review_ajax1").text(data[0].btitle);
							$(".review_ajax2").html(data[0].bcontent); // 내용에<br>태그있음!
			...
			<div>
				<span></span>
				<span class="review_ajax1">속초식 코다리찜</span>
				<span class="review_ajax2">
					재료가 워낙 좋으니 생선이라도 비린내 걱정 <br>없이 맛있었어요.나가서 사먹는것보다 <br>내 집에서 믿고먹는 맛집, 쿡킷입니다!
				</span>
				<span></span>
				<span>by.for********</span>
				<div>
		...
		<div id="menu">
			<div>
				...
				<span>
					장보기, 재료손질, 레시피검색 <strong>번거로움 OUT!</strong><br> 초간편함은 물론, 완벽한 맛 쿡킷이 다~ 했네
				</span>
				<ul>
					<li>
						<a href="#">
			...
			<div>
				...
				<span>
					파격적인 가격으로<br> 쿡킷을 경험할 수 있는 기회를 잡으세요.
				</span>
				<a href="#">
					...
					<span>
						COOKIT은 장보기, 재료손질, 계량 등 복잡한 과정 없이도<br> 누구나 간편하게 특별한 집밥을 만들 수 있도록 도와드립니다.
					</span>
				</a>
			</div>
		</div>
