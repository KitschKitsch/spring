			...
			<div id="contents">
				<div id="member">
					...
					<div class="btnAreaCenter">
						<a onclick="emailView()" style="cursor: pointer;"" class="gbtn">이메일 인증</a></li>
					</div>
					<!-- //Btn Area -->
					<script>
						let tempcode="";
						...
						function emailView(){
						   ...
						   $(".memberbd").css("display","block"); /* 디스플레이를 보.이.게! */
						}
					...
					<!-- 이메일 인증 생성: pom에 repository 코드 2개 붙여넣기!!! -->
					<div class="memberbd">
							<table summary="이름, 아이디, 비밀번호, 비밀번호 확인, 이메일, 이메일수신여부, 주소, 휴대폰, 유선전화, 생년월일 순으로 회원가입 정보를 등록할수 있습니다." class="memberWrite" border="1" cellspacing="0">
								...
								<tbody>
									...
									<tr>
										<th scope="row"><span>인증코드 입력 *</span></th>
										<td>
											<ul class="pta">
												<li class="r10"><input type="text" class="w134" name="temp_code" id="temp_code"/></li>
												<li><span class="mvalign">※ 이메일을 확인해주세요.</span></li>
											</ul>
										</td>
									</tr>
								</tbody>
						...
						<div class="btnArea">
							<div class="bCenter">
								<ul>
									...
									<li><a onclick="authBtn()" style="cursor: pointer;" class="sbtnMini">인증확인</a></li>
								</ul>
							</div>
						</div>
						<!-- //Btn Area -->
